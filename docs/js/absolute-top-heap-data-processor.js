class AbsoluteTopHeapDataProcessor extends BaseDataProcessor {
    constructor(rawData) {
        ...
        super(rawData, {
            dataKey: 'phases',
            filterFn: (row) => row.kind === 'absolute_top_heap_in_bytes',
            colorPalette: phaseColors,
            nameMapFn: mapPhaseName
        });
    }

    // Override getSummaryStats to provide absolute-top-heap-specific field names
    getSummaryStats() {
        ...
        return {
            ...
            totalAbsoluteTopHeap: stats.total,
